...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get downloadGeoJSON => 'Descargar GeoJSON';

  @override
  String get downloadKML => 'Descargar KML';

  @override
  String get copyGeoId => 'Copiar Geo ID';

  @override
  String get fieldCoordinatesDownloaded => 'Coordenadas del campo descargadas';

  @override
  String get noCoordinatesAvailable =>
      'No hay coordenadas disponibles para este campo';

  @override
  String get editEntry => 'Editar';

  @override
  String get editFarmerTitle => 'Editar agricultor';

  @override
  String get editFarmTitle => 'Editar finca';

  @override
  String get changesSaved => 'Cambios guardados exitosamente';

  @override
  String get editWindowExpired => 'Ventana de edición expirada (24 h)';

  @override
  String within24hEdit(int hours) {
    return 'Editable por $hours horas más';
  }

  @override
  String get exportUsersCsv => 'Exportar como CSV';

  @override
  String get noUsersToExport => 'No hay usuarios para exportar';

  @override
  String usersExportedCsv(int count) {
    return '$count usuarios exportados';
  }

  @override
  String get errorExportingUsers => 'Error al exportar usuarios';
  ...
  @override
  String get uploadFailed => 'Subida fallida. Por favor, inténtalo de nuevo.';

  @override
  String get uploadCanceled => 'Subida cancelada';
  ...
  @override
  String get registerAdditionalFarm => 'Registrar finca adicional';
  ...
  @override
  String get addFarmToFarmer => 'Agregar finca';

  @override
  String get addFieldToFarm => 'Agregar parcela';
  ...
  @override
  String get farmNameRequired => 'El nombre de la finca es obligatorio';
  ...
  @override
  String get cityName => 'Aldea/Comunidad';

  @override
  String get municipalityName => 'Municipio';
  ...
  @override
  String get gpsQualityAverage => 'Calidad GPS (Prom.)';

  @override
  String get gpsQualityRange => 'Calidad GPS (Rango)';
  ...
  @override
  String get gpsQualityExcellent => 'Excelente';

  @override
  String get gpsQualityGood => 'Buena';

  @override
  String get gpsQualityMedium => 'Media';

  @override
  String get gpsQualityPoor => 'Pobre';
  ...
  String get consentFormPhoto2 =>
      'Foto del Formulario de Consentimiento 2 (opcional)';

  @override
  String get consentFormPhoto2Optional =>
      'Opcional: Tome una segunda foto (p. ej., reverso del formulario)';

  @override
  String get takeConsentFormPhoto2 => 'Tomar 2da Foto de Consentimiento';

  @override
  String get retakeConsentFormPhoto2 =>
      'Volver a Tomar 2da Foto de Consentimiento';

  @override
  String get consentPhoto2Taken =>
      'Segunda foto de consentimiento tomada exitosamente';
  ...
  String get fieldPhotoRequired =>
      'Se requiere una foto del campo para completar el registro';
  ...
  @override
  String get polygonPreviewTitle => 'Verificar polígono';

  @override
  String get polygonPreviewDescription =>
      '¿El polígono capturado se ve correcto? Si no, puede rehacer la captura completa.';

  @override
  String get polygonPreviewConfirm => 'Se ve correcto';

  @override
  String get polygonPreviewRedo => 'Volver a capturar';

  @override
  String get noEmail => 'Sin correo electrónico';

  @override
  String get noValidAdminRole => 'No hay un rol de administrador válido';

  @override
  String noPermissionForRole(String role) {
    return 'Sin permiso para gestionar el rol: $role';
  }

  @override
  String get noValidUserRoleFound => 'No se encontró un rol de usuario válido';

  @override
  String noPermissionForCurrentRole(String role) {
    return 'Sin permiso para gestionar el rol actual: $role';
  }

  @override
  String get onlySuperadminCanUpdateEmail =>
      'Solo SUPERADMIN puede agregar direcciones de correo electrónico';

  @override
  String get emailUpdateOnlineOnly =>
      'La actualización de correo solo está disponible en línea';

  @override
  String get addEmailTitle => 'Agregar correo electrónico';
  ...
  String emailSaved(String email) {
    return 'Correo guardado: $email';
  }

  @override
  String uidCopied(String uid) {
    return 'UID copiado: $uid';
  }

  @override
  String errorChangingRole(String error) {
    return 'Error al cambiar el rol: $error';
  }
  ...
  String errorUpdatingEmail(String error) {
    return 'Error al actualizar el correo electrónico: $error';
  }

  @override
  String noPermissionForUserManagementWithRole(String role) {
    return 'Sin permiso para la gestión de usuarios. Su rol: $role';
  }

  @override
  String whispMissingGeoJsonWarning(String fields) {
    return 'Los siguientes campos no tienen un límite GeoJSON válido y se omitirán en el análisis de deforestación. Se marcarán en el PDF: $fields';
  }

  @override
  String get whispNoGeoJsonLabel => 'Sin datos de límites disponibles';

  @override
  String get whispAnalysisInProgress => 'Analizando riesgo de deforestación…';
  ...
  @override
  String get checkCloudButton => 'Verificar nube';

  @override
  String checkingCloud(int done, int total) {
    return 'Verificando la nube... $done/$total';
  }

  @override
  String cloudCheckResult(int ok, int missing) {
    return '$ok en la nube, $missing faltan';
  }

  @override
  String cloudCheckAllOk(int count) {
    return 'Las $count entradas están en la nube';
  }

  @override
  String resyncMissing(int count) {
    return 'Reenviar $count faltantes';
  }

  @override
  String get inCloud => 'En la nube';

  @override
  String get notInCloud => 'No está en la nube';
