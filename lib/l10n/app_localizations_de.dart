...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get downloadGeoJSON => 'GeoJSON herunterladen';

  @override
  String get downloadKML => 'KML herunterladen';

  @override
  String get copyGeoId => 'Geo-ID kopieren';

  @override
  String get fieldCoordinatesDownloaded => 'Feldkoordinaten heruntergeladen';

  @override
  String get noCoordinatesAvailable =>
      'Keine Koordinaten für dieses Feld verfügbar';

  @override
  String get editEntry => 'Bearbeiten';

  @override
  String get editFarmerTitle => 'Landwirt bearbeiten';

  @override
  String get editFarmTitle => 'Betrieb bearbeiten';

  @override
  String get changesSaved => 'Änderungen erfolgreich gespeichert';

  @override
  String get editWindowExpired => 'Bearbeitungsfenster abgelaufen (24 Std.)';

  @override
  String within24hEdit(int hours) {
    return 'Noch $hours Std. bearbeitbar';
  }

  @override
  String get exportUsersCsv => 'Als CSV exportieren';

  @override
  String get noUsersToExport => 'Keine Nutzer zum Exportieren';

  @override
  String usersExportedCsv(int count) {
    return '$count Nutzer exportiert';
  }

  @override
  String get errorExportingUsers => 'Fehler beim Exportieren der Nutzer';
  ...
  @override
  String get fastUpload => 'Fast Upload';

  @override
  String get fastUploadTitle => 'Fast Upload – Massenregistrierung von Feldern';

  @override
  String get fastUploadCsvSection => 'CSV-/Excel-Datei';

  @override
  String get fastUploadPickCsv => 'CSV-/Excel-Datei auswählen';

  @override
  String get fastUploadActionSection => 'Aktion';

  @override
  String get fastUploadProcess => 'Verarbeiten & Hochladen';

  @override
  String get fastUploadProcessing => 'Wird verarbeitet …';

  @override
  String get fastUploadReset => 'Zurücksetzen';

  @override
  String get fastUploadFormatHint => 'Unterstützte Formate';

  @override
  String fastUploadSaveGeoIds(int count) {
    return 'GeoIDs speichern ($count)';
  }

  @override
  String get fastUploadDryRun => 'Dry-Run Vorschau';

  @override
  String get fastUploadPersisting => 'Persistiere …';

  @override
  String get fastUploadPersistenceComplete => 'Persistierung abgeschlossen';

  @override
  String fastUploadPersistToDb(int count) {
    return 'In DB persistieren ($count)';
  }

  @override
  String get fastUploadFormatHintBody =>
      'CSV-Spalten:\nname, dni, polygon\n\nPolygon-Format:\n[-88.36,14.79];\n[-88.37,14.79];...\n\nXLSX-Spalten:\nsite, lat, lon, GeoID,\nassignedPersonName,\nMunicipality, Community,\nIntermediary, Buyer,\nproductiveCoffeeArea\nLastHarvestInHectares\n\nXLSX erzeugt ein Pseudo-\nPolygon aus Centroid\n+ Fläche.';

  @override
  String get fuLogOpeningFilePicker => 'Datei-Auswahl wird geöffnet …';

  @override
  String get fuLogCancelled => 'Abgebrochen – keine Datei ausgewählt.';
  ...
  @override
  String get fuLogWebPlatform => 'Web-Plattform erkannt – lese via Stream …';

  @override
  String fuLogBytesReceived(String size) {
    return '$size Bytes empfangen';
  }

  @override
  String get fuLogNativePlatform =>
      'Native Plattform erkannt – lese via File …';

  @override
  String fuLogBytesRead(String size) {
    return '$size Bytes gelesen';
  }

  @override
  String get fuLogCsvLoaded => 'CSV erfolgreich geladen';

  @override
  String fuLogTotalLines(int count) {
    return 'Zeilen gesamt : $count';
  }

  @override
  String fuLogTotalChars(int count) {
    return 'Zeichen gesamt: $count';
  }

  @override
  String get fuLogFirst120 => 'Erste 120 Zeichen:';

  @override
  String get fuLogCsvReady =>
      'CSV bereit. Klicke auf \\\"Verarbeiten & Hochladen\\\".';
  ...
  String get fuLogNoCsvLoaded =>
      'Keine CSV-Datei geladen – bitte zuerst eine Datei auswählen.';

  @override
  String get fuLogUploadStarted => 'Fast-Upload gestartet';

  @override
  String get fuLogStep1 => 'SCHRITT 1: CSV PARSEN';

  @override
  String get fuLogNoPolygons => 'Keine gültigen Polygone gefunden – Abbruch.';

  @override
  String fuLogPolygonsExtracted(int count) {
    return '$count Polygon(e) erfolgreich extrahiert';
  }

  @override
  String fuLogFieldNamesCached(int count) {
    return 'Feldnamen gespeichert (für Ergebnis-Korrelation): $count';
  }

  @override
  String get fuLogStep2 => 'SCHRITT 2: GEOJSON ERSTELLEN';

  @override
  String get fuLogFeatureCollectionCreated => 'FeatureCollection erstellt';
  ...
  String fuLogFeature0Points(int count) {
    return 'Feature 0: $count Koordinatenpunkte';
  }

  @override
  String get fuLogStep3 => 'SCHRITT 3: AUTHENTIFIZIERUNG';

  @override
  String get fuLogCredentialsMissing =>
      'API-Zugangsdaten fehlen in der .env-Datei!';
  ...
  @override
  String get fuLogConnecting => 'Verbinde mit AgStack User Registry …';

  @override
  String get fuLogServiceInitialized => 'Service initialisiert';

  @override
  String get fuLogLoginFailed => 'Login fehlgeschlagen – Zugangsdaten prüfen.';

  @override
  String get fuLogLoginSuccess => 'Login erfolgreich';

  @override
  String fuLogTokenPreview(String preview) {
    return 'Bearer-Token (erste 20 Zeichen): $preview…';
  }

  @override
  String get fuLogStep4 => 'SCHRITT 4: HOCHLADEN (MULTIPART)';

  @override
  String get fuLogSendingMultipart => 'Sende multipart/form-data …';

  @override
  String fuLogPolygonCount(int count) {
    return 'Polygone : $count';
  }

  @override
  String fuLogTimeout(String label, int seconds, int count) {
    return 'Timeout  : $label  (${seconds}s = $count × 2s + 60s Puffer)';
  }

  @override
  String get fuLogWaitingForServer => 'Warte auf Server-Antwort …';

  @override
  String get fuLogStep5 => 'SCHRITT 5: SERVER-ANTWORT';
  ...
  String fuLogResponseSize(String size) {
    return 'Antwort-Größe: $size';
  }

  @override
  String fuLogUploadSuccess(int code) {
    return 'Upload erfolgreich (HTTP $code)';
  }
  ...
  @override
  String get fuLogLoggedOut => 'Abgemeldet von User Registry';

  @override
  String get fuLogLogoutFailed => 'Logout fehlgeschlagen (ignoriert)';
  ...
  @override
  String get fuLogProcessDone => 'Prozess abgeschlossen';

  @override
  String fuLogSavingGeoIds(int count, String filename) {
    return 'Speichere $count GeoIDs als \\\"$filename\\\" …';
  }

  @override
  String fuLogGeoIdsSaved(String filename) {
    return 'Datei erfolgreich gespeichert/heruntergeladen: $filename';
  }
  ...
  @override
  String get fuLogRawPreview => 'JSON-ANTWORT (RAW PREVIEW)';

  @override
  String get fuLogDetailedAnalysis => 'DETAILLIERTE ERGEBNIS-ANALYSE';

  @override
  String get fuLogNotJsonObject => 'Antwort ist kein JSON-Objekt – Rohanzeige:';

  @override
  String fuLogServerMessage(String msg) {
    return 'Server-Nachricht: $msg';
  }

  @override
  String get fuLogNoResultsArray =>
      'Kein \\\"results\\\"-Array in der Antwort.';

  @override
  String get fuLogFullResponse => 'Vollständige Antwort (formatiert):';

  @override
  String fuLogTotalResults(int count) {
    return 'Ergebnisse gesamt: $count';
  }

  @override
  String fuLogEntryNotObject(int index, String value) {
    return 'Eintrag $index ist kein Objekt: $value';
  }

  @override
  String get fuLogStatusNew => '✅ NEU REGISTRIERT';

  @override
  String get fuLogStatusExisting => 'ℹ️  BEREITS VORHANDEN';
  ...
  String fuLogGeoIdSource(String id, String src) {
    return 'Geo-ID  : $id  (Feld: $src)';
  }

  @override
  String get fuLogGeoIdMissing => 'Geo-ID  : (nicht vorhanden)';

  @override
  String fuLogApiMessage(String msg) {
    return 'Nachricht: $msg';
  }

  @override
  String fuLogCoordPoints(int count) {
    return 'Punkte  : $count Koordinatenpunkte im Polygon';
  }

  @override
  String get fuLogSummary => 'ZUSAMMENFASSUNG';
  ...
  String fuLogSummaryNew(int count) {
    return '✅ Neu registriert       : $count';
  }

  @override
  String fuLogSummaryExisting(int count) {
    return 'ℹ️  Bereits vorhanden     : $count';
  }
  ...
  @override
  String get fuLogErrorDetails => 'Fehler-Details:';

  @override
  String fuLogGeoIdsReadyForExport(int count) {
    return '$count GeoIDs bereit zum Export';
  }

  @override
  String get fuLogClickSaveButton =>
      '→ \\\"GeoIDs speichern\\\"-Button im linken Panel klicken';

  @override
  String fuLogParseError(String error) {
    return 'Fehler beim Parsen der Antwort: $error';
  }

  @override
  String get fuLogRawText => 'Rohtext der Antwort:';

  @override
  String fuLogDelimiterDetected(String delimiter, int semicolons, int commas) {
    return 'Trennzeichen erkannt: \\\"$delimiter\\\" ($semicolons Semikola vs. $commas Kommas außerhalb Anführungszeichen)';
  }

  @override
  String get fuLogEolWindows => 'Zeilen-Ende: Windows (\\r\\n)';

  @override
  String get fuLogEolMac => 'Zeilen-Ende: Mac OS Classic (\\r)';

  @override
  String get fuLogEolUnix => 'Zeilen-Ende: Unix/macOS (\\n)';

  @override
  String fuLogParsedRows(int count) {
    return 'Geparste Zeilen: $count (inkl. Header)';
  }

  @override
  String get fuLogNoCsvDataRows => 'CSV enthält keine Datenzeilen';

  @override
  String fuLogHeaderColumns(String cols) {
    return 'Header-Spalten: $cols';
  }

  @override
  String get fuLogNoPolygonColumn =>
      'Keine \\\"polygon\\\"/\\\"coordinates\\\"/\\\"koordinaten\\\"-Spalte gefunden';

  @override
  String fuLogAvailableColumns(String cols) {
    return 'Verfügbare Spalten: $cols';
  }

  @override
  String fuLogPolygonColumn(int index, String name) {
    return 'Polygon-Spalte  : Index $index (Spaltenname: \\\"$name\\\")';
  }

  @override
  String fuLogNameColumn(int index, String name) {
    return 'Namen-Spalte    : Index $index (Spaltenname: \\\"$name\\\")';
  }

  @override
  String get fuLogNoNameColumn =>
      'Namen-Spalte    : nicht gefunden – generierter Name wird verwendet';

  @override
  String fuLogRowTooShort(int row, int count, int need) {
    return 'Zeile $row: nur $count Spalten vorhanden (benötigt > $need) → übersprungen';
  }

  @override
  String fuLogEmptyCoords(int row, String name) {
    return 'Zeile $row \\\"$name\\\": Koordinatenzelle ist leer → übersprungen';
  }

  @override
  String fuLogTooFewPoints(int row, String name) {
    return 'Zeile $row \\\"$name\\\": weniger als 4 Polygon-Punkte → übersprungen';
  }

  @override
  String fuLogRowParsed(int row, String name, int count) {
    return '✔ Zeile $row  \\\"$name\\\"  →  $count Punkte';
  }

  @override
  String fuLogSkipped(int count) {
    return '$count Zeile(n) übersprungen';
  }

  @override
  String fuLogParseSummary(int features, int skipped) {
    return 'Erfolgreich geparst: $features Features, übersprungen: $skipped';
  }
  ...
  String fuLogPersistHeader(int count) {
    return 'DATENBANK-PERSISTIERUNG ($count Felder)';
  }

  @override
  String get fuLogPersistSubtitle =>
      'Läuft im Hintergrund – Upload-Ergebnisse werden in DB gespeichert';

  @override
  String fuLogDryRunHeader(int count) {
    return '🔍 DRY-RUN VORSCHAU ($count Felder) – KEINE DB-Änderungen';
  }

  @override
  String get fuLogDryRunSubtitle =>
      'Zeigt an, was persistiert werden würde. Keine Datenbank-Interaktion.';

  @override
  String get fuLogDryRunWouldCreate =>
      '   🔍 [DRY-RUN] Würde neu anlegen via generateDigitalSibling';
  ...
  String fuLogDryRunCoords(int count, String first) {
    return '      Koordinaten : $count Punkte (erster: $first)';
  }

  @override
  String fuLogDryRunQuerying(String geoId) {
    return '   🔍 [DRY-RUN] Abfrage Firebase für GeoID: $geoId';
  }

  @override
  String get fuLogDryRunNotFound =>
      '      DB-Befund   : ⚠️  Kein Eintrag gefunden';

  @override
  String get fuLogDryRunWouldCreateNew =>
      '      Aktion      : → würde neu anlegen via generateDigitalSibling';

  @override
  String get fuLogDryRunFound => '      DB-Befund   : ✅ Eintrag gefunden';
  ...
  String get fuLogDryRunNoChange =>
      '      Aktion      : ℹ️  Keine Änderung nötig';

  @override
  String fuLogDryRunActions(String actions) {
    return '      Aktion      : → $actions';
  }

  @override
  String fuLogDryRunAddOwner(String uid) {
    return 'Owner hinzufügen ($uid)';
  }

  @override
  String get fuLogDryRunSetBoundaries => 'Boundaries setzen';

  @override
  String get fuLogDryRunSetStartDate => 'existenceStarts setzen';
  ...
  String fuLogPersistedNew(String geoId) {
    return '   ✅ Neu angelegt  →  GeoID: $geoId';
  }

  @override
  String fuLogPersistedUpdated(String geoId) {
    return '   ✅ Aktualisiert  →  GeoID: $geoId';
  }

  @override
  String fuLogPersistedAlreadyFull(String geoId) {
    return '   ℹ️  Bereits vollständig  →  GeoID: $geoId';
  }

  @override
  String fuLogPersistedNewFromExisting(String geoId) {
    return '   ✅ Neu angelegt (war bereits bei API registriert)  →  GeoID: $geoId';
  }
  ...
  @override
  String get fuLogPersistDone => 'PERSISTIERUNG ABGESCHLOSSEN';

  @override
  String fuLogPersistSummaryNew(int count) {
    return '   ✅ Neu angelegt      : $count';
  }
  ...
  String get fuLogDryRunDone =>
      'DRY-RUN ABGESCHLOSSEN – nichts wurde geschrieben';

  @override
  String fuLogDryRunSummaryNew(int count) {
    return '   🔍 Würde neu anlegen  : $count';
  }

  @override
  String fuLogDryRunSummaryUpdated(int count) {
    return '   🔍 Würde aktualisieren: $count';
  }
  ...
  @override
  String get registerAdditionalFarm => 'Zusätzliche Farm registrieren';
  ...
  @override
  String get addFarmToFarmer => 'Farm hinzufügen';

  @override
  String get addFieldToFarm => 'Feld hinzufügen';
  ...
  @override
  String get farmNameRequired => 'Farm-Name ist erforderlich';
  ...
  @override
  String get mapTypeLabel => 'Kartenansicht';

  @override
  String get mapTypeNormal => 'Standard';

  @override
  String get mapTypeSatellite => 'Satellit';

  @override
  String get mapTypeHybrid => 'Hybrid';

  @override
  String get mapTypeTerrain => 'Gelände';
  ...
  @override
  String get consentFormPhoto2 => 'Einverständniserklärung Foto 2 (optional)';

  @override
  String get consentFormPhoto2Optional =>
      'Optional: Zweites Foto aufnehmen (z.B. Rückseite des Formulars)';

  @override
  String get takeConsentFormPhoto2 => '2. Einverständnisfoto aufnehmen';

  @override
  String get retakeConsentFormPhoto2 =>
      '2. Einverständnisfoto erneut aufnehmen';

  @override
  String get consentPhoto2Taken =>
      'Zweites Einverständnisfoto erfolgreich aufgenommen';
  ...
  @override
  String get polygonPreviewTitle => 'Polygon überprüfen';

  @override
  String get polygonPreviewDescription =>
      'Sieht das erfasste Polygon korrekt aus? Falls nicht, können Sie die gesamte Aufnahme von vorne beginnen.';

  @override
  String get polygonPreviewConfirm => 'Sieht korrekt aus';
  ...
  String whispAnalysisError(String error) {
    return 'Entwaldungsanalyse fehlgeschlagen: $error';
  }

  @override
  String get ihcafeDirectoryTitle => 'IHCafé-Produzentenverzeichnis';

  @override
  String get ihcafeNotAvailable =>
      'Auf diesem Gerät noch nicht vorhanden. Lade die IHCafé-Exportdatei im Online-Zustand herunter (ca. 33 MB) und importiere sie hier. Danach kannst du Produzenten vollständig offline suchen und auswählen.';

  @override
  String get ihcafeProducersLabel => 'Produzenten';

  @override
  String get ihcafeDepartamentoLabel => 'Departamento';

  @override
  String get ihcafeProjectLabel => 'Projekt';

  @override
  String get ihcafeExportedLabel => 'Exportiert';

  @override
  String get ihcafeImportedLabel => 'Importiert';

  @override
  String get ihcafeStoredSizeLabel => 'Belegter Speicher';

  @override
  String get ihcafeImportFile => 'Datei importieren';

  @override
  String get ihcafeReplaceFile => 'Datei ersetzen';

  @override
  String get ihcafeDeleteTitle => 'IHCafé-Verzeichnis löschen?';

  @override
  String get ihcafeDeleteBody =>
      'Die Produzentenliste wird von diesem Gerät entfernt. Für die Offline-Auswahl musst du sie erneut importieren.';

  @override
  String get ihcafeMissingTitle => 'IHCafé-Verzeichnis fehlt';

  @override
  String get ihcafeMissingBody =>
      'Die Produzentenliste wurde auf diesem Gerät noch nicht importiert. Importiere sie einmalig im Online-Zustand, danach funktioniert sie offline.';

  @override
  String get ihcafeSelectProducerTitle => 'Produzent aus IHCafé wählen';

  @override
  String get ihcafeSelectProducerButton => 'Produzent aus IHCafé-Liste wählen';

  @override
  String get ihcafeSearchLabel => 'Name, identidad oder clave';

  @override
  String get ihcafeSearchHint => 'z.B. JUAN PEREZ oder 0719-1993';

  @override
  String get ihcafeOnlyVigente => 'Nur vigente';
  ...
  @override
  String get ihcafeNoProducerFound => 'Kein Produzent gefunden.';

  @override
  String ihcafeProducerCount(int count) {
    return '$count Produzenten';
  }

  @override
  String get ihcafeWhichFincaTitle => 'Welche Finca?';

  @override
  String ihcafeWhichFincaBody(String name, int count) {
    return '$name hat $count Fincas bei IHCafé. Wähle die, der diese Farm entspricht - ihre finca_id wird an der Farm gespeichert.';
  }

  @override
  String get ihcafeSkip => 'Überspringen';
  ...
  @override
  String get ihcafeRemoveLink => 'Verknüpfung zum IHCafé-Datensatz entfernen';

  @override
  String get syncSectionTitle => 'Synchronisierung';

  @override
  String get pauseUploads => 'Upload pausieren';

  @override
  String get uploadsPausedHint =>
      'Upload pausiert - Daten werden nur lokal gespeichert';

  @override
  String get uploadsActiveHint => 'Upload aktiv';
  ...
  String itemsWaitingForUpload(int count) {
    return '$count Element(e) warten auf den Upload';
  }

  @override
  String get allItemsSynced => 'Alles synchronisiert';
  ...
  @override
  String get lastSyncNever => 'nie';

  @override
  String get toolsAndSettings => 'Werkzeuge & Einstellungen';
  ...
  @override
  String get syncedShort => 'Synchron';

  @override
  String get uploadPausedShort => 'Pausiert';
  ...
  @override
  String get syncResultNothingToDo => 'Nichts hochzuladen';

  @override
  String syncResultFailed(int count) {
    return '$count fehlgeschlagen - wird wiederholt';
  }

  @override
  String syncResultConflicts(int count) {
    return '$count mit Merge-Konflikt';
  }

  @override
  String get syncAlreadyRunning => 'Eine Synchronisierung läuft bereits';

  @override
  String syncNextRetry(String time) {
    return 'Nächster Versuch: $time';
  }
  ...
  @override
  String get pendingItemsTitle => 'Wartende Elemente';

  @override
  String get pendingItemConflict => 'Merge-Konflikt';

  @override
  String get syncPhaseMedia => 'Fotos werden hochgeladen';

  @override
  String get syncPhasePush => 'Daten werden hochgeladen';

  @override
  String get syncPhasePull => 'Daten werden geladen';

  @override
  String get photoNotUploadedYet =>
      'Foto noch nicht hochgeladen\n(liegt noch auf dem Gerät des Registrars)';

  @override
  String get qcSearchHint => 'Name, ID oder Registrar suchen...';

  @override
  String get qcAllRegistrars => 'Alle Registrare';

  @override
  String get qcNoMatches => 'Keine Registrierungen passen zum Filter';

  @override
  String get sortByRegistrar => 'Registrar (A-Z)';

  @override
  String get sortByType => 'Typ';
  ...
  String qcLoadingDetails(int done, int total) {
    return 'Lade Datum und Registrar... $done/$total';
  }

  @override
  String get qcRegisteringInAssetRegistry =>
      'Registriere Feld in der Asset Registry...';

  @override
  String get qcSavingDecision => 'Speichere Entscheidung und synchronisiere...';

  @override
  String get qcUpdatingPhotos => 'Aktualisiere verknüpfte Fotos...';

  @override
  String itemsLostForUpload(int count) {
    return '$count Element(e) können nicht hochgeladen werden';
  }

  @override
  String get pendingItemLost => 'Lokale Kopie verloren';

  @override
  String get checkCloudButton => 'Cloud prüfen';

  @override
  String checkingCloud(int done, int total) {
    return 'Prüfe Cloud... $done/$total';
  }

  @override
  String cloudCheckResult(int ok, int missing) {
    return '$ok in der Cloud, $missing fehlen';
  }

  @override
  String cloudCheckAllOk(int count) {
    return 'Alle $count Einträge sind in der Cloud';
  }

  @override
  String resyncMissing(int count) {
    return '$count fehlende erneut senden';
  }

  @override
  String get inCloud => 'In der Cloud';

  @override
  String get notInCloud => 'Nicht in der Cloud';
